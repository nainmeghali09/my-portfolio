  ...
  return (
    <div className='px-2 pb-4 pt-10 mb-3 bg-slate-900 md:px-8 lg:px-16'>
      <div className='text-center text-white mb-4'>
        ...
        <p>
          A collection of UI Designs made 100% in Figma{"  "}
          <a
      ...
      <div className='flex flex-wrap justify-center gap-3'>
        <figure className='px-4 py-2 bg-slate-400 flex-grow flex justify-center items-center  md:transform md:transition md:duration-500 md:hover:scale-125'>
          <img
            src={design1}
